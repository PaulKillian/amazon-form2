        ...
        <h1 className={ redoForm === null ? 'hidden' : null}>
          ...
          <img className={'logo-dimensions'} src={logo} alt='amazon logo'/>
            <form className={'form-flex'} onSubmit={handleSubmit}>
              ...
              <input type='text' name='password' placeholder='At least 6 characters'required onChange={handleChange}/>
              <p>&#9432; Passwords must be at least 6 characters.</p>
              <label>Re-enter password</label>
              <input type='text' name='reenter' required onChange={handleChange}/>
